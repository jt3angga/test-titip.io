        ...
        dataSource && ports && ports.length > 1 ? (
            ...
            >
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col">
                        <div className="text-sm text-right">{ports[ports.length - 1].properties.locode}</div>
                        <div className="text-xs text-right">{ports[ports.length - 1].properties.name}</div>
                    </div>
                </div>
            </div>
        ) : null
